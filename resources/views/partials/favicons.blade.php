<link rel="icon" type="image/png" href="{{ asset('storage/favicons/favicon-96x96.png') }}" sizes="96x96" />
<link rel="icon" type="image/svg+xml" href="{{ asset('storage/favicons/favicon.svg') }}" />
